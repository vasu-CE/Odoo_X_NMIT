        ...
        <Sidebar className="border-r border-gray-200/60 backdrop-blur-sm bg-white/70 relative z-10">
          <SidebarHeader className="border-b border-gray-200/60 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-gray-900 text-lg">ManufacturingOS</h2>
                        ...
                        <Link to={item.url} className="flex items-center gap-3 px-3 py-3">
                          <div className={`p-2 rounded-lg transition-colors duration-200 ${
                            ...
                            <item.icon className={`w-4 h-4 ${
                              location.pathname === item.url ? item.color : 'text-gray-500'
                            }`} />
                          </div>
          ...
          <SidebarFooter className="border-t border-gray-200/60 p-4 bg-white/30 backdrop-blur-sm">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-gray-900 text-sm truncate">Production Manager</p>
                <p className="text-xs text-gray-500 truncate">Manage production workflows</p>
              </div>
              <Button variant="ghost" size="icon" className="hover:bg-gray-200/60">
          ...
          <header className="bg-white/80 backdrop-blur-md border-b border-gray-200/60 px-6 py-4 md:hidden sticky top-0 z-20">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-xl font-bold text-gray-900">ManufacturingOS</h1>
              </div>
